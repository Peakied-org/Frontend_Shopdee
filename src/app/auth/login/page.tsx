                ...
                <div className="w-1/2 flex items-center justify-center">
                    <div className="bg-white p-4 w-[75%] h-fit">
                        ...
                        <form className="flex flex-col space-y-4 mt-8 items-center">
                            ...
                            <button className="bg-custom-green text-white p-2 text-xl uppercase w-[30%]">login</button>
                        </form>
                        <p className="mt-4 text-center text-zinc-400 text-lg">
                            New to ShopDee? <a href="/auth/register" className="text-emerald-500 hover:underline font-semibold">Register</a>
                        </p>
                    </div>
                </div>
            </div>
